...
public class DBHelper extends SQLiteOpenHelper {
    ...
    //static final String FASTEST_COL = "fastest";
    //static final String AVERAGE_SCORE_COL = "average";
    ...
    public void onCreate(SQLiteDatabase db) {
        String create_table = "create table " + TABLE_NAME
                ...
                + LEVEL_COL + " int default 1 check("
                            +LEVEL_COL + " in (1,2,3)),"
                + DATE_COL + " timestamp default CURRENT_TIMESTAMP,"
                + IMAGE_COL + " text default 'c'"
                + ")";
    ...
    public boolean insertPlayer(String usr, int score, int level, String image_name){
        ...
        values.put(IMAGE_COL, image_name);
